    ...
    const {values, errors, handleChange, handleSubmit, touched, resetForm} =
        useFormik({
            ...
            onSubmit: values => {
                ...
                annotation.note.label = values.title;

                annotation.note.remark = values.remark;

                annotation.color = values.color;
